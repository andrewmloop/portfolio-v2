...
export default function Footer() {
  return (
    <div id="footer" className="flex flex-col justify-center align-middle w-full h-auto  bg-black">
        ...
        <div className="h-[6rem] w-[6rem] bg-white rounded-full m-4">
          <div className="relative h-[4rem] w-[4rem] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
            <a href="https://www.linkedin.com/in/andrewmloop/" target="_blank" rel="noreferrer">
              <Image src="/icons/linkedin-150-gold.png" alt="LinkedIn logo."
                width={150}
                height={150}
        ...
        <div className="h-[6rem] w-[6rem] bg-white rounded-full m-4">
          <div className="relative h-[4rem] w-[4rem] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
            <a href="https://github.com/andrewmloop" target="_blank" rel="noreferrer">
              <Image src="/icons/github-128-gold.png" alt="Github logo."
                width={128}
                height={128}
                className="rotate-0 scale-100 duration-1000 hover:rotate-[360deg] hover:scale-105 ease-in-out motion-reduce:transition-none"
              />
        ...
        <div className="h-[6rem] w-[6rem] bg-white rounded-full m-4">
          <div className="relative h-[4rem] w-[4rem] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
            <a href="mailto:andrewmloop@gmail.com">
              <Image src="/icons/at-sign-100-gold.png" alt="@ icon."
                width={100}
                height={100}
                className="rotate-0 scale-100 duration-1000 hover:rotate-[360deg] hover:scale-105 ease-in-out motion-reduce:transition-none"
              />
      ...
      <p className="text-center text-white border-t-2 w-3/4 mx-auto py-4 my-4">Made in 2022 by AML. <a href="https://www.github.com/andrewmloop/portfolio-v2" className="hover:underline">Code.</a></p>
    </div>
  );
}