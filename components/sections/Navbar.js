...
export default function Navbar() {
  ...
  return (
    <div className="sticky top-0 w-full p-2 md:p-4 bg-black z-10">
      <nav className="flex justify-between items-center">
        ...
        {/* Nav Links */}
        <div className={`fixed ${active ? "" : "translate-x-[100vw] md:translate-x-0"} top-0 right-0 h-screen w-[66vw] bg-light-navy transition-transform duration-[400ms] ease-in-out md:relative md:h-auto md:w-auto md:bg-inherit md:top-auto`}>
